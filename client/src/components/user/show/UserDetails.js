...
export const UserDetails = (props) => {
    ...
    const closeHandler = () => {
        props.setDetailsIsShown(false)
    }

    const { _id, firstName, lastName, email, phoneNumber, imageUrl, createdAt, updatedAt, address: { country, city, street, streetNumber} = {} } = {...user};
    return (
